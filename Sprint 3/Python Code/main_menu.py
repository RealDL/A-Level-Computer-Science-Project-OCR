...
class MainMenu:
    def __init__(self):
        ...
        self.sound_box = Button((27,31,35), (39,174,96), (self.settings.WIDTH/2)*1.45, (self.settings.HEIGHT/2)*0.97, "Graphics/Fonts/Orbitron-Regular.ttf", (240,240,240), (136,173,227), self.base_button_height*0.4, self.base_button_height*0.4,'','Rectangle', None, self.big_text_size, self.curve)
        self.music_box = Button((27,31,35), (39,174,96), (self.settings.WIDTH/2)*1.45, (self.settings.HEIGHT/2)*1.08, "Graphics/Fonts/Orbitron-Regular.ttf", (240,240,240), (136,173,227), self.base_button_height*0.4, self.base_button_height*0.4,'','Rectangle', None, self.big_text_size, self.curve)
        ...
        self.ip_text_box = TextBox(self.base_button_width*2.5, self.base_button_height*1.5, (self.settings.WIDTH/2), (self.settings.HEIGHT/2)*0.99, (240,240,240), (200,200,200),"Graphics/Fonts/Orbitron-Regular.ttf",self.curve,self.thickness,self.base_button_width*2.5)
        ...
        self.name_text_box = TextBox(self.base_button_width*2.5, self.base_button_height*1.5, (self.settings.WIDTH/2), (self.settings.HEIGHT/2)*0.70, (240,240,240), (200,200,200),"Graphics/Fonts/Orbitron-Regular.ttf",self.curve,self.thickness,self.base_button_width*2.5)
