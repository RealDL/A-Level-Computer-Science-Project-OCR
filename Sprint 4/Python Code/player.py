...
class Player(pygame.sprite.Sprite):
    def __init__(self, pos, image, groups, obstacle_sprites, username, id, health, create_attack=None, destroy_attack=None, create_bullet=None, create_magic=None, movement="WASD", offense="Space", magic="L-Shift"):
        # Setting up player
        try:
