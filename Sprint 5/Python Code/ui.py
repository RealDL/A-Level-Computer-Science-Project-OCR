...
class UI(Config):
    def __init__(self, custom_mouse, quit_function, player_count, kill_count):
        ...
        self.kill_count = Button(self.UI_BG_COLOR, self.UI_BG_COLOR, self.WIDTH-(self.HEALTH_BAR_WIDTH)/2-10-2, 13.5+(self.BAR_HEIGHT/2)+2, "Graphics/Fonts/Orbitron-Medium.ttf", self.TEXT_COLOR, self.TEXT_COLOR, (self.HEALTH_BAR_WIDTH), self.BAR_HEIGHT, f'Kill count: {self.player_kill_count}', 'Rectangle', None, self.UI_FONT_SIZE, 0)
